...
- 阶段 11 验收项“用户无需手动录入即可开始使用”建议再补更多公共词库示例数据
...
1. **准备示例数据**（公共词库 + 学习记录演示数据）
2. **整理 README 与接口文档**（对外可读性与上手效率）
3. **Redis 缓存策略收口**（热点缓存与失效策略明确化）
4. **交互细节修复**（空态、重试路径、提示语一致性再打磨）

若以“可展示/可交接”为目标，优先做 1 + 2。
